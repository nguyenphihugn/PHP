        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form action="/chieu2-main/product/save" method="post" enctype="multipart/form-data">
                    <h1 class="mt-5">Edit Products</h1>
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input value="<?= $product->name ?>" type="text" class="form-control form-control-lg" id="name"
                            name="name" placeholder="Product Name">
                    </div>

                    <!-- Password input -->
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input value="<?= $product->price ?>" type="number" class="form-control form-control-lg"
                            id="price" name="price" placeholder="Product Price">
                    </div>

                    <div data-mdb-input-init class="form-outline mb-4">
                        <input value="<?= $product->description ?>" type="text" class="form-control form-control-lg"
